...
const { data:BuyersData, isError, isLoading }:any = useContractRead({
 ...
 const {data: marketData, isliading:isMarketLoading, isError: isMarketError, onSuccess}:any = useContractReads({
    contracts: nftMeta,
    onSuccess(data){
    ...
    <>
      <Head>
        ...
        <PageLayout>
          ...
          <h1 className="text-2xl font-bold text-center mb-[-10%] mt-20"> AVAILABLE ITEMS </h1>
